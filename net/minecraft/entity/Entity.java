...
public abstract class Entity
{
    ...
    public void setTimer(int par1)
    {
    	timer = par1;
    }
    
    public int getTimerStun()
    {
    	return timerStun;
    }
    
    public void setTimerStun(int par1)
    {
    	timerStun = par1;
    }
