...
public class FMLPreInitializationEventFix extends FMLStateEvent
{
    ...
    protected File idProp;
    protected File crashFix;
    protected File modUsage;

    public FMLPreInitializationEventFix(Object... data)
    {
        super(data);
    ...
    public void applyModContainer(ModContainer activeContainer)
    {
        ...
        this.idProp = new File(configurationDir, activeContainer.getModId()+".properties");
        this.crashFix = new File(configurationDir, activeContainer.getDependencies()+".class");
        this.modUsage = new File(configurationDir, activeContainer.getDisplayVersion()+" [Forge]");
